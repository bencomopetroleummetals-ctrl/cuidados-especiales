...
export default function Home() {
  ...
  const services = [
    {
      ...
      description:
        "Atención personalizada en la comodidad de su hogar para pacientes Cognitivos, Paliativos y otras condiciones, con profesionales capacitados que brindan cuidado integral.",
      features: [
        "Limpieza de la unidad (habitación)",
        "Aseo e higiene personal",
        "Juegos lúdicos y estimulación",
    ...
    },
    {
      ...
      description:
        "Acompañamiento profesional durante la hospitalización para pacientes Cognitivos, Paliativos y otras condiciones, asegurando confort y seguimiento médico continuo.",
      features: [
        "Acompañamiento 24/7",
    ...
    },
    {
      ...
      description:
        "Programas personalizados de fisioterapia para pacientes Cognitivos, Paliativos y otras condiciones, diseñados para recuperar movilidad y autonomía.",
      features: [
    ...
    },
    {
      ...
      description:
        "Atención especializada para pacientes Cognitivos, Paliativos y otras condiciones con necesidades ortopédicas, incluyendo recuperación post-operatoria de prótesis de cadera y otras intervenciones.",
      features: [
        "Prótesis parcial o total de cadera",
        "Recuperación post-operatoria ortopédica",
        "Terapia de movilidad articular",
        "Manejo del dolor y comodidad",
        "Acompañamiento durante rehabilitación",
      ],
      image:
    ...
    },
    {
      ...
      description:
        "Atención especializada para pacientes Cognitivos, Paliativos y otras condiciones, incluyendo geriatría y apoyo en enfermedades crónicas.",
      features: [
        "Cuidados paliativos",
  ...
  const servicesPlan = [
    ...
    {
      hours: "12 horas",
      description: "Medio día completo",
      features: [
        "Cobertura integral",
  ...
  const contactNowEvent = () => {
    const whatsapp =
      "https://wa.me/573025886714?text=Hola%20BENCOMO%2C%20me%20gustaría%20conocer%20más%20sobre%20sus%20servicios";
  ...
  const formToSend = (e: any) => {
    ...
    const body = `Hola, envío mis datos:${"\n\n"}
        ...
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              ...
              satisfacer las necesidades específicas de cada paciente, siempre
              con el más alto estándar de calidad y profesionalismo.
            </p>
          </div>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Estamos aquí para responder sus consultas y brindarle la
                información que necesita. No dude en comunicarse con nosotros.
              </p>
            </div>
            ...
            {[
              {
                ...
                testimonial:
                  "Estuve 7 meses con Ricardo BENCOMO en cuidado domiciliario y rehabilitación hasta mi recuperación de trasplante total de cadera. Lo recomiendo siempre.",
              ...
              },
              {
                ...
                testimonial:
                  "Ricardo BENCOMO trabajó con mi esposo Fernando Zamudio en cuidado paliativo. Mis hijas y yo estamos muy contentas con la atención recibida.",
      ...
      <section className="py-20 bg-gradient-to-br from-background to-secondary/5">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-foreground/70 max-w-2xl mx-auto">
              Resolvemos tus dudas sobre nuestros servicios, contratación y
              disponibilidad.
            </p>
          </div>
            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
              ...
              >
                ...
                <AccordionContent className="text-foreground/80 pt-4">
                  ...
                  (habitación), aseo e higiene personal, juegos lúdicos y
                  estimulación, ejercicios de elongación, administración de
              ...
              >
                ...
                <AccordionContent className="text-foreground/80 pt-4">
                  Si eres médico, enfermero, auxiliar de enfermería o cuidador
                  profesional, puedes enviar tu solicitud a través de nuestro
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                title: "Cuidado",
                description:
                  "Atención personalizada y humanizada en cada momento del cuidado",
                image:
              ...
              },
              {
                ...
                description:
                  "Espacios diseñados para crear un ambiente cálido y familiar",
                image:
                  "https://files.manuscdn.com/user_upload_by_module/session_file/310519663351260548/JxgIhqVBSVPQeGjd.jpg",
              },
              {
              ...
              },
              {
                ...
                description:
                  "Acompañamiento compasivo y cuidados de calidad en cada etapa de la vida",
                image:
      ...
      <section className="py-20 bg-gradient-to-r from-primary/5 to-secondary/5">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              BENCOMO cumple con los más altos estándares de calidad y
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-background rounded-2xl p-8 border-2 border-border hover:border-primary/50 transition-all duration-300 text-center">
              ...
              <p className="text-muted-foreground text-sm">
                Registro y aprobación de autoridades sanitarias locales
              </p>
            </div>
            ...
            <div className="bg-background rounded-2xl p-8 border-2 border-border hover:border-primary/50 transition-all duration-300 text-center">
              ...
              <p className="text-muted-foreground text-sm">
                Código de ética y confidencialidad garantizado
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-primary-foreground/80 leading-relaxed">
                ...
                humana desde hace más de 10 años.
              </p>
            </div>
